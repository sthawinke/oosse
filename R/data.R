...
#'
#' RNA-sequencing data of genetically identical Brassica napus plants in autumn, with 5 phenotypes next spring, as published by \insertRef{DeMeyer2023}{oosse}.
#'
