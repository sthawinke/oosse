...
test_that("skillScoreSE throws errors when incorrect input is provided", {
    ...
    expect_error(skillScoreSE(meanLoss = .3, refLoss = 4, refLossSE = .03, meanLossSE = 0.04, skillScore = "Peirce", corEst = 0.75))
    })
test_that("skillScoreSE works as expected with correct input", {
    ...
    expect_length(skillScoreSE(meanLoss = .3, refLoss = .4, refLossSE = .03, meanLossSE = 0.04, skillScore = "Peirce", corEst = 0.75), 2)
