...
test_that("skillScoreSE throws errors when incorrect input is provided", {
    expect_error(skillScoreSE(meanLoss = 3, margVar = 4, meanLossSE = 0.4, n = 0, corEst = 0.75, skillScore = "R2"))
    expect_error(skillScoreSE(meanLoss = -3, margVar = 4, meanLossSE = 0.4, n = 50, corEst = 0.75, skillScore = "R2"))
    expect_error(skillScoreSE(meanLoss = 3, margVar = -4, meanLossSE = 0.4, n = 50, corEst = 0.75, skillScore = "R2"))
    expect_error(skillScoreSE(meanLoss = 3, margVar = 4, meanLossSE = -0.4, n = 50, corEst = 0.75, skillScore = "R2"))
    expect_error(skillScoreSE(meanLoss = 3, margVar = 4, meanLossSE = 0.4, n = 50, corEst = 2, skillScore = "R2"))
