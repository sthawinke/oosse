...
```{r reglinmodR2}
if(require(glmnet)){
    R2pen = R2oosse(y = Brassica$Pheno$Leaf_8_width, x = Brassica$Expr[, seq_len(25)], #Subset genes for speed
                    nFolds = 3, cvReps = 5e1, nBootstrapsCor = 25,
...
if(require(randomForest)){
    ...
    R2rf = R2oosse(y = Brassica$Pheno$Leaf_8_width, x = Brassica$Expr[, seq_len(25)],
                     nFolds = 3, cvReps = 5e1, nBootstrapsCor = 25,
