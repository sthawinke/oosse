...
This vignette demonstrates the use of the __oosse__ package for estimating for estimating the out-of-sample R² and its standard error through resampling algorithms by \textcite{Hawinkel2023}.
...
We adapt the parameter settings a bit to reduce computation time

```{r reglinmodR2}
R2pen = R2oosse(y = Brassica$Pheno$Leaf_8_width, x = Brassica$Expr[, seq_len(5e2)], 
