...
```{r reglinmodR2}
R2pen = R2oosse(y = Brassica$Pheno$Leaf_8_width, x = Brassica$Expr, nFolds = 5, cvReps = 1e2,
                    fitFun = fitFunReg, predFun = predFunReg, alpha = 1)#Lasso model
```

## Support vector machine

As a final example we use a support vector machine as a prediction model. We use the implementation from the _e1071_ package.
